...
/**
 * 1) use topological sort + DFS to iterate over orderings that satisfy constraint
 * 2) since we want to retrieve all possible orderings, we need to keep track of "free" variables in each
 * iteration, then simulate taking that variable, before further DFS
 * <p>
